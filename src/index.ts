...
export const getStats = (group = {}) => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.stats, { group }).then(
...
export const getCurrentBandwidthSetting = () => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.bwlimit).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const setCurrentBandwidthSetting = (newRate) => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.bwlimit, { rate: newRate }).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const createNewPublicLink = (remoteName, remotePath) => {
  ...
  return new Promise((resolve, reject) => {
    axiosInstance
      .post(urls.createPublicLink, { fs: remoteName, remote: remotePath })
      .then(
        (res) => {
          resolve(res.data);
        },
...
export const getAllProviders = () => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.getProviders).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const getAllConfigDump = () => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.getConfigDump).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const getAllRemoteNames = () => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.listRemotes).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const getJobStatus = (jobId) => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.getStatusForJob, { jobId }).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
 ...
 */
export const getDownloadURLForFile = (
  ipAddress,
  fsInfo,
  remoteName,
  remotePath,
...
export const backendCommand = (command, arg, opt, fs) => {
  ...
  return new Promise((resolve, reject) => {
    if (!command || !arg || !opt)
      throw new Error(
        `One or more invalid arguments {${command}},{${arg}} {${opt}} {${fs}}`
      );
    axiosInstance
      .post(urls.backendCommand, {
        command,
        arg,
        opt,
        fs,
...
export const coreCommand = (arg, opt) => {
  return new Promise((resolve, reject) => {
    if (!arg || !opt)
      throw new Error(`One or more invalid arguments ,{${arg}} {${opt}}`);
    axiosInstance
      .post(urls.coreCommand, {
        arg,
        opt,
      })
      .then(
...
export const getTransferredStats = (group) => {
  ...
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.transferred, data).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const stopJob = (jobId) => {
  ...
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.stopJob, data).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const getSize = (srcFs, srcRemote) => {
  ...
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.getSize, data).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const statsDelete = (group) => {
  ...
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.statsDelete, data).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
...
export const statsReset = (group) => {
  ...
  return new Promise((resolve, reject) => {
    axiosInstance.post(urls.statsReset, data).then(
      (res) => {
        resolve(res.data);
      },
      (error) => {
